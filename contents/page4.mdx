...
### なんならサーバ側も、Firebaseや、CloudFunction、AWS Lamda + Node.jsを使って、フロントの人間が書いちゃおう。
...
### いや、Webのままネイティブでしかできなかったことをできるようにしよう。
